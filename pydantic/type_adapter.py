...
def _get_schema(type_: Any, config_wrapper: _config.ConfigWrapper, parent_depth: int) -> CoreSchema:
    ...
    global_ns = _typing_extra.NsWrapper(_typing_extra.ImmutableNs(sys._getframe(max(parent_depth - 1, 1)).f_globals))
    if local_ns:
        global_ns = global_ns.merge_namespace(_typing_extra.ImmutableNs(local_ns))
