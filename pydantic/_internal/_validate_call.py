...
class ValidateCallWrapper:
    ...
    def __init__(
        ...
        namespace: _typing_extra.NsWrapper | None,
    ):
        ...
        global_ns = _typing_extra.ImmutableNs.from_module_ns_of(function)
        ...
        ns_wrap = _typing_extra.NsWrapper(
            _typing_extra.ImmutableNs({param.__name__: param for param in type_params}),
            global_ns,
            namespace,
        )

        config_wrapper = ConfigWrapper(config)
        gen_schema = _generate_schema.GenerateSchema(config_wrapper, ns_wrap)
